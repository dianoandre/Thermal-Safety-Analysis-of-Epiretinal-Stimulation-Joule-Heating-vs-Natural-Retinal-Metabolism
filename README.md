...
![COMSOL Multiphysics](https://img.shields.io/badge/COMSOL-Multiphysics_6.4-blueviolet.svg)
![Bioengineering](https://img.shields.io/badge/Field-Bioengineering-success.svg)
...
The implemented Pennes Bioheat Equation takes the following form:

```math
\rho C_p \frac{\partial T}{\partial t} + \nabla \cdot (-k \nabla T) = Q_{met} + \rho_b C_{p,b} \omega_b (T_b - T) + Q_{Joule}
```

Where $Q_{met}$ is the natural metabolic heat of the retina, the $\omega_b$ term represents the choroidal blood perfusion cooling, and $Q_{Joule}$ is the heat generated by the electrical stimulation.
